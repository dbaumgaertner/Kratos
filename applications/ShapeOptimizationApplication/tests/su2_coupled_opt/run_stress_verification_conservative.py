...
with open("parameters_fsi_optimization.json",'r') as parameter_file:
    ...
    parameters["su2_interface_settings"]["su2_related"]["config_file"].SetString("ubend_coarse_for_fd_verification.cfg")
...
for move_node_id in list_of_move_nodes:
    ...
    shutil.copy("restart_flow.csv", case_dir+"/")
    shutil.copy("ubend_coarse_for_fd_verification.cfg", case_dir+"/")
